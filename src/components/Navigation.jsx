            ...
            <nav>
                <ul>
                    ...
                    <div className="info-column">
                        ...
                        <li className="nav-info" onClick={clickManager}>About</li>
                    </div>
                </ul>
            </nav>
            {about && <div className="about">
                <button className="close-button" onClick={closeManager}>X</button>
                <h1>About</h1>
                <div className="about-text">
                    <p>This game was inspired by <em>'Where's Waldo?'</em>. Instead of finding Waldo, you have to find the cat hidden in each photo!
                    Try to do it quickly to compete for <strong>a spot on the leaderboard!</strong>
                    </p>
                    <p>
                        All the photos are courtesy of the <em>There Is No Cat</em> subreddit. <br/>
