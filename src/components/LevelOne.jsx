...
import checkInside from "./levelOneHelperFunction";
...
const LevelOne = () => {
    ...
    const fetchPost = async () => {
        ...
        await getDocs(collection(db, "coordinates "))
            .then((querySnapshot)=>{               
                ...
                console.log(coordinates[0], newData);
            })
    ...
    return (
        <div>
            ...
            <div className="red" fade={fade} onAnimationEnd={() => setFade(0)}>Try again!</div>
            <img ref={catPicRef} src={LevelOneBackground} onClick={clickManager} alt="Level one background" />
