...
/* Helper function to make a target shape out of the coords that are provided and checks to see if a point 
is within bounds of the shape that has been created.*/
